...
function updateSelectedContact(user_id) {
    $(document).find(".messenger-list-item").removeClass("m-list-active bg-primary");
  $(document)
    .find(
      ".messenger-list-item[data-contact=" + (user_id || getMessengerId()) + "]"
    )
      .addClass("m-list-active bg-primary");
}
/**
 *-------------------------------------------------------------
 * Global Templates
...
$(document).ready(function () {
  ...
  $("body").on("click", ".messenger-list-item", function () {
      $(".messenger-list-item").removeClass("m-list-active bg-primary");
      $(this).addClass("m-list-active bg-primary");
