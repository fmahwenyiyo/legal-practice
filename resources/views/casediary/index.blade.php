                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="#" class="btn btn-sm btn-primary"
                                    onclick="document.getElementById('customer_submit').trigger('submit'); return false;"
                    ...
                    <table class="table dataTable data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                    <a href="#" class="btn btn-sm" data-url="{{ route('cases.show', $case->id) }}"
                                        data-size="md" data-ajax-popup="true" data-title="{{ __('View Cause') }}">
