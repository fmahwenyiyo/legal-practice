                                                ...
                                                <div class="logo-content mt-4">
                                                    <a href="{{ $logo .'/'. (isset($logo_dark) && !empty($logo_dark) ? $logo_dark : 'logo-dark.png') }}" target="_blank">
                                                        <img id="blah" alt="your image"
                                                            src="{{ $logo .'/'. (isset($logo_dark) && !empty($logo_dark) ? $logo_dark : 'logo-dark.png') }}" width="200px"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('mail_driver', env('MAIL_DRIVER'), ['class' => 'form-control',
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    'form-control', 'placeholder' => __('Enter Mail From Address')]) }}
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-6">
                                <a href="#" class="btn btn-primary  send_email" data-title="{{ __('Send Test Mail') }}"
                                    data-url="{{ route('test.mail') }}" data-ajax-popup="true">
                                    {{ __('Send Test Mail') }}
                                </a>
                            </div>
                                                                            ...
                                                                            <div class="form-check">
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        !isset($store_settings['paypal_mode'])
                                                                                        ||
                                                                                        $store_settings['paypal_mode']==''
                                                                                        ||
                                                                                        $store_settings['paypal_mode']=='sandbox'
                                                                                        ? 'checked="checked"' : '' }}>
                                                                                    {{__('Sandbox')}}
                                                                                </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check">
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        isset($store_settings['paypal_mode'])
                                                                                        &&
                                                                                        $store_settings['paypal_mode']=='live'
                                                                                        ? 'checked="checked"' : '' }}>
                                                                                    {{__('Live')}}
                                                                                </label>
                                                                            </div>
                                        ...
                                        <div class="col switch-width">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary"
                                                    ...
                                                    {{!empty(env('RECAPTCHA_MODULE')) && env('RECAPTCHA_MODULE')=='yes'
                                                    ? 'checked="checked"' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                        ...
                                        <input class="form-control" placeholder="{{ __('Enter Google Recaptcha Key') }}"
                                            name="google_recaptcha_key" type="text" value="{{env('NOCAPTCHA_SITEKEY')}}"
                                            id="google_recaptcha_key">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                        <label for="google_recaptcha_secret" class="form-label">{{ __('Google Recaptcha
                                            Secret') }}</label>
                                        <input class="form-control "
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::text('pusher_app_secret',env('PUSHER_APP_SECRET'),array('class'=>'form-control
                                    font-style'))}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::text('pusher_app_cluster',env('PUSHER_APP_CLUSTER'),array('class'=>'form-control
                                    font-style'))}}
