                ...
                <div class="">
                    ...
                    @if(!empty($permissions))
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @php
                                    $modules=['dashboard','advocate','document','doctype','member','group','court','highcourt','bench','cause','case','todo','bill','tax','diary','timesheet','expense','feereceived','calendar','setting'];
                                @endphp
