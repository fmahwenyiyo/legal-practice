            ...
            <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                ...
                <div class="all-button-box mx-2">
                    <a data-bs-toggle="tooltip" onclick="saveAsPDF2()" class="btn btn-sm btn-primary " data-bs-placement="top"
                        title="{{__('Download')}}" href="#!" target="_blanks" data-bs-original-title="{{ __('Download') }}" >
                        {{ __('Download') }}
                    </a>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="d-none tax-rate">{{ App\Models\Tax::getTax($item['tax'])->rate
                                                        }}</span>
                                                </td>
                                                <td class="amount">
                                                    <b>$0.00</b>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ \App\Models\Utility::get_file($bankPayment->receipt) }}" class="btn  btn-outline-primary btn-sm"
                                        ...
                                        <td>
                                            ...
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="#" data-size="lg" data-url="{{ route('bankpayment.show', $bankPayment->id) }}"
                                            ...
                                            <div class="action-btn bg-danger ms-2">
                                                ...
                                                ['invoice.bankpayment.delete', $bankPayment->id]]) !!}
                                                <a href="#!" class="mx-3 btn btn-sm  align-items-center text-white bs-pass-para" data-bs-toggle="tooltip"
                                                    title='Delete'>
