...
<div class="text-sm-end d-flex all-button-box justify-content-sm-end">
    <a href="{{ route('casediary.index') }}" class="btn btn-sm btn-primary mx-1" data-bs-toggle="tooltip"
            ...
            <div class="card shadow-none">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 mt-2 col-6">
                            <h5>{{ __('Calendar') }}</h5>
                        </div>
                        ...
                        <div class="col-md-4 col-6 my-2">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-2">
                                    ...
                                    <h4 class="mb-0 text-info">{{ count($case_data) }}</h4>
