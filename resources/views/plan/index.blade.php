                    ...
                    <div class="card shadow-none  price-card price-1 rounded-0">
                        <div class="card-body">
                            ...
                            <span class="mb-4 f-w-500 p-price">
                                {{(env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$')}} {{ number_format($plan->price)
                            ...
                            <div class="row d-flex justify-content-between">
                                ...
                                @elseif($plan->price<=0) @endif @endcan @if($plan->id != 1 && \Auth::user()->plan !=
                                    $plan->id &&
                                    ...
                                    <div class="col-3">
                                        ...
                                        <a href="{{ route('send.request',[\Illuminate\Support\Facades\Crypt::encrypt($plan->id)]) }}"
                                            ...
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Send Request')}}">
                                            <span class="btn-inner--icon"><i class="fas fa-share"></i></span>
                                        </a>
                                        @else
                                        <a href="{{ route('request.cancel',\Auth::user()->id) }}"
                                            class="btn btn-danger btn-icon btn-sm" data-title="{{__('Cancle Request')}}"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
