                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="float-end">
                                                            ...
                                                            <button class="btn btn-primary d-flex align-items-center" type="submit">
                                                                ...
                                                                (<span class="bank-final-price">{{ env('CURRENCY_SYMBOL') ?
                                                                    env('CURRENCY_SYMBOL') : '$' }}{{ $plan->price }}</span>)
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center" type="submit"
                                                        ...
                                                        {{ __('Pay Now') }} (<span class="toyyibpay-final-price">{{ env('CURRENCY_SYMBOL') ?
                                                            env('CURRENCY_SYMBOL') : '$' }}{{ $plan->price }}</span>)</button>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="float-end">
                                                                ...
                                                                <button class="btn btn-primary d-flex align-items-center" type="submit"
                                                                    id="pay_with_payfast">
                                                                    <i class="mdi mdi-cash-multiple mr-1"></i>
                                                                    {{ __('Pay Now') }} (<span class="payfast-final-price">{{ env('CURRENCY_SYMBOL')
                                                                        ? env('CURRENCY_SYMBOL') : '$' }}{{ $plan->price }}</span>)</button>
                                                            </div>
                                                        </div>
                                                    </div>
