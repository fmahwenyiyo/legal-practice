...
{{ Form::open(['route' => 'advocate.store','method' => 'post', 'id' => 'frmTarget', 'enctype' => 'multipart/form-data'])
}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::url('website', null, ['class' => 'form-control','required' => 'required']) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::number('tin', null, ['class' => 'form-control','required' => 'required']) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                'col-form-label']) }}
                                {{ Form::text('pan_number', null, ['class' => 'form-control','required' => 'required'])
                                }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::number('hourly_rate', null, ['class' => 'form-control','required' =>
                                'required']) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                'col-form-label']) }}
                                {{ Form::text('ofc_address_line_1', null, ['class' => 'form-control','required' =>
                                'required']) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                'col-form-label']) }}
                                {{ Form::text('ofc_address_line_2', null, ['class' => 'form-control','required' =>
                                'required']) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::number('ofc_zip_code', null, ['class' => 'form-control','required' =>
                                'required']) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                'col-form-label']) }}
                                {{ Form::text('home_address_line_1', null, ['class' => 'form-control','required' =>
                                'required']) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                'col-form-label']) }}
                                {{ Form::text('home_address_line_2', null, ['class' => 'form-control','required' =>
                                'required']) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                {{ Form::label('city', __('City'), ['class' => 'col-form-label']) }}
                                <select class="form-control" id="home_city" name="home_city" required>
                                    <option value="">{{ __('Select City') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                {{ Form::label('zip_code', __('Zip/Postal Code'), ['class' => 'col-form-label']) }}
                                {{ Form::number('home_zip_code', null, ['class' => 'form-control','required' =>
                                'required']) }}
                            </div>
                        </div>
                                                ...
                                                <table class="table  mb-0 table-custom-style"
                                                    ...
                                                    <tbody class="ui-sortable" data-repeater-item>
                                                        <tr>
                                                            ...
                                                            <td width="25%">
                                                                <input type="text"
                                                                    class="form-control contact_designation"
            ...
            <div class="card shadow-none rounded-0 border ">
                <div class="card-body p-2">
                    <div class="form-group col-12 d-flex justify-content-end col-form-label mb-0">
                        ...
                        <a href="{{ route('advocate.index') }}" class="btn btn-secondary btn-light ms-3">{{ __('Cancel')
                            }}</a>
                ...
                success: function(result) {
                    $.each(result.data, function(key, value) {
                        $("#country").append('<option value="' + value.id + '">' + value
                            .country + "</option>");
                        $("#home_country").append('<option value="' + value.id + '">' + value
                            .country + "</option>");
                    });
                },
            });
