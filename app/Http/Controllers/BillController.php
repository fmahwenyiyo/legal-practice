...
class BillController extends Controller
{
    ...
    public function create()
    {
        if (Auth::user()->can('create bill')) {
            $advocates = Advocate::where('created_by', Auth::user()->creatorId())->get()->pluck('name', 'id');
            $taxes = Tax::where('created_by', Auth::user()->creatorId())->get()->pluck('name', 'id');
            $invoice_number = Auth::user()->invoiceNumberFormat($this->invoiceNumber());

            return view('bills.create', compact('advocates', 'taxes', 'invoice_number'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::user()->can('create bill')) {
            ...
            if ($request->bill_from == 'advocate') {
                ...
                $bill['custom_advocate'] = $request->custom_advocate;
                $bill['custom_address'] = $request->custom_address;
                $bill['custom_email'] = $request->custom_email;
            }
    ...
    public function edit($id)
    {
        if (Auth::user()->can('edit bill')) {
            ...
            $taxes = Tax::where('created_by', Auth::user()->creatorId())->get()->pluck('name', 'id');
            $bill = Bill::find($id);
            return view('bills.edit', compact('advocates', 'taxes', 'bill'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
