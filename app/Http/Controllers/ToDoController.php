...
class ToDoController extends Controller
{
    ...
    public function index()
    {
        if (Auth::user()->can('manage todo')) {
            $todos = ToDo::where('created_by',Auth::user()->creatorId())->get();
            ...
            return view('todo.index',compact('todos','upcoming_todo','pending_todo','complted'));
        } else {
    ...
    public function create()
    {
        if (Auth::user()->can('create todo')) {
            ...
            $teams = User::where('created_by',Auth::user()->creatorId())->get()->pluck('name', 'id');
            return view('todo.create', compact('cases', 'teams'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
    ...
    public function edit($id)
    {
        if (Auth::user()->can('delete todo')) {
            ...
            $relate_to = Cases::where('created_by',Auth::user()->creatorId())->whereIn('id', explode(',', $todo->relate_to))->get();
            $assign_to = User::where('created_by',Auth::user()->creatorId())->whereIn('id', explode(',', $todo->assign_to))->get();

           return view('todo.edit', compact('todo','cases','teams','relate_to','assign_to'));
