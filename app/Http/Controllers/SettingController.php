...
class SettingController extends Controller
{
    ...
    public function adminSettings()
    {
        if (Auth::user()->can('manage system settings')) {
            ...
            return view('settings.admin', compact('settings', 'file_size', 'payment'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function saveGoogleCalenderSettings(Request $request)
    {
        ...
        if (isset($request->is_google_calendar_enabled) && $request->is_google_calendar_enabled == 'on') {
            ...
            $post['is_google_calendar_enabled'] = $request->is_google_calendar_enabled;
        } else {
            $post['is_google_calendar_enabled'] = 'off';
        }
